...
func getCourseType(course: FirstQuarterTechnicalCourse) -> String {
    ...
    switch course {
    // if it's these 3, then it's web
    case .python, .frontend, .ruby: courseType = "Web"
    // if it's these 2, then it's mobile
...
func getWeekdayName(weekday: Weekday) -> String {
    //    var theWeekday: String
    //
    //    switch weekday {
    //        case .Monday:theWeekday = "This weekday is called \(Weekday.Monday.rawValue)"
    //        case .Tuesday:theWeekday = "This weekday is called \(Weekday.Tuesday.rawValue)"
    //        case .Wednesday:theWeekday = "This weekday is called \(Weekday.Wednesday.rawValue)"
    //        case .Thursday:theWeekday = "This weekday is called \(Weekday.Thursday.rawValue)"
    //        case .Friday:theWeekday = "This weekday is called \(Weekday.Friday.rawValue)"
    //        case .Saturday:theWeekday = "This weekday is called \(Weekday.Saturday.rawValue)"
    //        case .Sunday:theWeekday = "This weekday is called \(Weekday.Sunday.rawValue)"
    //    }
    //
    //    return theWeekday
...
func isItFinallyWeekend(weekday: Weekday) -> String {
    var day: String
    switch weekday {
    case .Saturday, .Sunday:day = "Wuhuuuu, it's SATURDAYYYYYYYY. "
    //        case .Monday, .Tuesday, .Wednesday, .Thursday, .Friday:day = "Aghh, it's a regular workday"
    default:day = "Aghh, it's a regular workday"
    }
