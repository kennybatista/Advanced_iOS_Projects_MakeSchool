...
struct Board {
    fileprivate var currentTurn: Player = .cross // cross begins every game
...
//var board = Board()
//
//board.move(player: .cross, x: 0, y: 0)
//board.winner()
//board.move(player: .circle, x: 2, y: 2)
//board.winner()
//board.move(player: .cross, x: 0, y: 2)
//board.winner()
//board.move(player: .circle, x: 0, y: 2)
//board.winner()
